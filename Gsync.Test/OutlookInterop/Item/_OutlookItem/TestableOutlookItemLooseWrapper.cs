...
namespace Gsync.Test.OutlookInterop.Item
{
    public class TestableOutlookItemLooseWrapper : OutlookItemWrapperLoose
    {
        ...
        public TestableOutlookItemLooseWrapper(object item) : base(item) { }

        public TestableOutlookItemLooseWrapper(object item, ItemEvents_10_Event events = null)
            : base(item, events) { Init(); }

        public TestableOutlookItemLooseWrapper(object item, ItemEvents_10_Event events, ImmutableHashSet<string> supportedTypes)
